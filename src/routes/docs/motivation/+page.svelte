<div class="content">
   <h1>MOTIVATION</h1>
   <a id="download" href="/docs/CV-shcherbakov-aleksandr.pdf">Download as PDF ↓</a>
   ...
   <p>However, the turning point for me was the wide adoption of smartphones. I have witnessed how computers transitioned from being professional tools to essential personal companions. Access to the internet became so effortless that mobile computing became <i>not just a part, but a whole digital extension of our life</i>. Seeing how intuitive, interactive and fluid touch interfaces can be, I have naturally <i>wanted to become a part of this revolution.</i></p>
   <p>Since then, I have been committed to building mobile interfaces with outstanding user experience. Taught by years of limitations, I have always strived for responsiveness and efficiency and wanted interactions to feel the same. This desire has also motivated me to take up competitive programming in high school. As a result, I have acquired a strong foundation in computer science, and my team ranked second at the Siberian ICPC finals. In addition, I have passed the national CS exam with a maximum score, <i>an achievement obtained by only 0.36% of graduates</i>, hence securing my place at ITMO University on a government-funded basis.</p>
   ...
   <p>In addition to the degree, <i>I have co-founded a mobile development team</i> with my EU-based business partner. We have provided small enterprises with cross-platform applications which scaled their reach and sales, most notably during the pandemic. Although it was challenging to maintain a high quality of work and studies during busy periods, this combination of education and business provided me with priceless <i>decision-making, time management and teamwork skills</i>, which I find crucial to succeed in any competitive environment.</p>
   <p>Today the landscape for modern application development has seemingly settled, though I refuse to believe that a 5-inch brick of glass and metal is the endpoint. Just like once it was with smartphones, it now feels like we are on the verge of the next generation of interfaces. <i>Specifically spatial ones.</i></p>
   <p>My ultimate goal is to research and build <i>ambient computing systems which seamlessly enhance user experience</i>. I am interested in how computers can escape the limiting box of a screen and become a natural part of our life — <i>inclusive, sustainable and effortless. I am convinced that the HCI program is the perfect place to become a versatile developer capable of leveraging the latest achievements in XR, IoT and ML to build the foundation for future innovation.</p>
