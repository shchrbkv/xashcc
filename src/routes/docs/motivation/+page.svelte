...
<div class="content">
   ...
   <p>I am especially interested in the program's curriculum — with courses in <i>human-computer interaction, machine learning and mobile networking,</i> it covers all the building blocks for the digital environments of tomorrow. Moreover, I am excited to collaborate on projects for <i>CHI, SIGGRAPH and other conferences</i>. The immersion in international and diverse community of interdisciplinary scholars will enable me to <i>make well-informed contribution to this rapidly-growing field.</i></p>
   <p>In addition to academic potential, I am deeply interested in using cutting-edge facilities such as Aalto Studios to <i>build projects at the forefront of human-computer interfaces.</i> I have been a longtime collaborator on 3D motion graphics with a large YouTube channel, hence the ability to <i>apply my visual skills in an advanced production environment</i> greatly inspires me.</p>
   <p>Overall, the opportunity of being a part of your program sets high standards for me as a student and drives me to bring the most innovative ideas to life. Including the ultimate one — <i>becoming a highly-skilled expert, which my future university will be proud of.</i></p>
